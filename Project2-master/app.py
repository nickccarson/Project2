...
#### config file
app.config["SQLALCHEMY_DATABASE_URI"] = 'postgres://postgres:N4$hville@localhost:5432/Superstore'
...
engine = create_engine('postgres://postgres:N4$hville@localhost:5432/Superstore')
conn = engine.connect()
...
# adding routes for the individual pages
